...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/aether", permission: authz.ChannelRead, handler: controller.GetAetherIntegration},
	{method: http.MethodPut, path: "/:id/aether", permission: authz.ChannelSensitiveWrite, handler: controller.UpsertAetherIntegration},
	{method: http.MethodPost, path: "/:id/aether/sync", permission: authz.ChannelSensitiveWrite, handler: controller.SyncAetherIntegration},
