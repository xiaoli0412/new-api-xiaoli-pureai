...
func (user *UserBase) WriteContext(c *gin.Context) {
	...
	common.SetContextKey(c, constant.ContextKeyUserRateLimit, user.RequestRateLimit)
	common.SetContextKey(c, constant.ContextKeyUserConcurrency, user.ConcurrentLimit)
}
