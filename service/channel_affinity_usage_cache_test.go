...
func channelAffinityUsageCacheTestIdentifiers() (string, string) {
	id := channelAffinityUsageCacheTestSequence.Add(1)
	return fmt.Sprintf("rule_%d", id), fmt.Sprintf("fp_%d", id)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := channelAffinityUsageCacheTestIdentifiers()
	usingGroup := "default"
